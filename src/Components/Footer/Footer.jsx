    ...
    <footer className="px-4 divide-y bg-gray-800 text-gray-100">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        <div className="lg:w-1/4">
          ...
          <p>
            Our ticket system simplifies support by organizing every request
            into a single, easy-to-manage dashboard. It ensures that no issue is
            forgotten by tracking progress in real-time
          </p>
        </div>
